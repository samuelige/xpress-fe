...
import AllDealsTableHeader from './tableColumn';
import { dealsData } from './mockData';
import EmptyDealState from './EmptyDealState';
...
const Deals = () => {
    ...
    useEffect(() => {
        if (dealsData) {
            setRetrieveData(dealsData);
        }

        setBreadcrumbsData({
            pathName: 'Deals',
            length: String(dealsData.length || 0)
        })
        ...
        <div className='py-3 px-4 flex flex-row items-center justify-between'>
            ...
            <div className="mt-3 space-x-4 lg:mt-0 w-full flex flex-row lg:w-[17.875rem] xl:w-[30rem] ">
                ...
                <div className=''>
                    ...
                    >
                        <span className="text-sm font-semibold">Add New Deals</span>
                    </Button>
                </div>
