...
import AllTransactionsTableHeader from './tableColumn';
...
const Transactions = () => {
    ...
    const columns: any = useMemo(
        () =>
        AllTransactionsTableHeader((item) => (
            <Actions/>
          )),
        []
    );
    ...
    useEffect(() => {
        if (transactionsData) {
            setRetrieveData(transactionsData);
        }

        setBreadcrumbsData({
            pathName: 'Transactions',
            length: String(transactionsData.length || 0)
        })
        ...
        <div className='py-3 px-4 flex flex-row items-center justify-between'>
            ...
            <div className="mt-3 space-x-4 lg:mt-0 w-full flex flex-row lg:w-[17.875rem] xl:w-[30rem] ">
                ...
                <div className=''>
                    ...
                    >
                        <span className="text-sm font-semibold">Add New Transactions</span>
                    </Button>
                </div>
